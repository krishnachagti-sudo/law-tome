...
The Law Tome has one voice across 1,116 entries and every page the build
generates. This is that voice, written down so it survives the next thousand
edits and so a reader cannot tell which sentence was written when.
