...
const FEATURES = [
  ...
  { href: 'quiz/', cta: 'Play the quiz',
    ...
    title: 'Ten questions, four ways to be wrong',
    body: 'Name a law from its statement, match one to what it actually says, place it in its field, and say how far it can be trusted. Learn the index by playing it, not just searching it. (The law of the day opens the front page.)' },
